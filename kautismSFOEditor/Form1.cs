    ...
    public partial class Form1 : Form {
        ...
        private void defaultSFOToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                Registry.ClassesRoot.CreateSubKey("KautismSFOEditor\\DefaultIcon").SetValue("", "\"" +Application.ExecutablePath + "\",1");
                Registry.ClassesRoot.CreateSubKey("KautismSFOEditor\\Shell\\Open\\Command").SetValue("", "\"" + Application.ExecutablePath + "\" \"%1\"");
